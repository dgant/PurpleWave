...
object KeyboardCommands {
  ...
  def onSendText(text: String) {
    text match {
      case "q"          => breakpoint()
      case "c"          => With.camera.enabled            = true
      ...
      case "1"          => With.game.setLocalSpeed(1000)  ; With.camera.enabled = true
      case "2"          => With.game.setLocalSpeed(60)    ; With.camera.enabled = true
      case "3"          => With.game.setLocalSpeed(30)    ; With.camera.enabled = true
      case "4"          => With.game.setLocalSpeed(0)     ; With.camera.enabled = true
