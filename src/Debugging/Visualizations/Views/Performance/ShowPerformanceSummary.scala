...
object ShowPerformanceSummary extends View {
  ...
  override def renderScreen() {
    ...
    DrawScreen.header(155, With.performance.frameMeanMs + "ms avg")
    DrawScreen.header(230, With.performance.frameMaxMs  + "ms max")
    DrawScreen.header(305, JBWAPIClient.framesBehind()  + " frames back")
    val short = "+" + With.configuration.frameLimitMs.toString + "ms: "
