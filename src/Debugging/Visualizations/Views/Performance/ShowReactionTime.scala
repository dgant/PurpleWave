  ...
  override def renderScreen() {
    DrawScreen.table(
      ...
      Vector(
        ...
        Vector("Samples:",    With.agents.cycleLengths.size.toString,   With.battles.clustering.runtimes.size.toString, With.battles.estimationRuntimes.size.toString,  With.prioritizer.frameDelays.size.toString),
