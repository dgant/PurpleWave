  ...
  override def renderScreen() {
    DrawScreen.table(
      ...
      Vector(
        ...
        Vector("Avg:",        With.reaction.agencyAverage.toString,     With.reaction.clusteringAverage.toString,       With.reaction.estimationAverage.toString,       With.reaction.planningAverage.toString,     With.reaction.gridUnitsAverage.toString),
