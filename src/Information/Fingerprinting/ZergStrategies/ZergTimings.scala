...
object ZergTimings {
  ...
  object TwelveHatch_HatchCompleteBy              extends GameTime(2, 54)
  object TwelveHatch11Pool_PoolCompleteBy         extends GameTime(2, 49)
  object TwelveHatch11Pool10Gas_GasCompleteBy     extends GameTime(2, 36)
