...
class FingerprintRobo extends FingerprintOr(
  new FingerprintCompleteBy(Protoss.RoboticsFacility,   GameTime(6, 30)),
  new FingerprintCompleteBy(Protoss.RoboticsSupportBay, GameTime(7, 30)),
  new FingerprintCompleteBy(Protoss.Observatory,        GameTime(7, 30)),
  new FingerprintCompleteBy(Protoss.Reaver,             GameTime(9, 0)),
  new FingerprintCompleteBy(Protoss.Observer,           GameTime(7, 30)),
