...
object Support extends Action {
  ...
  override def allowed(unit: FriendlyUnitInfo): Boolean = unit.canMove && isSupport(unit) && false // COG 2021: Experimenting with disabling this now that we have formations
