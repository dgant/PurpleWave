...
class MovementProfile(
  ...
  var preferStrength    : Double = 0,
  var preferExploration : Double = 0,
  ...
  def heuristics: Iterable[WeightedMovementHeuristic] =
    List(
      ...
      new WeightedMovementHeuristic(TileHeuristicStrength,          preferStrength,     Colors.BrightViolet),
      new WeightedMovementHeuristic(TileHeuristicExploration,       preferExploration,  Colors.MediumTeal),
