...
object Opponents {
  ...
  val defaultPvP  = new StrategySelectionRecommended(StrategySelectionGreedy, PvP2Gate1012)
  val defaultPvZ  = new StrategySelectionRecommended(StrategySelectionGreedy, PvZ4Gate1012, PvZMidgame5GateGoon)
  ...
  val microwave     : Opponent = add(Opponent("Microwave",    new StrategySelectionRecommended(StrategySelectionDynamic, PvZ4Gate1012, PvZMidgame5GateGoon)))
  val megabot       : Opponent = add(Opponent("MegaBot",      defaultPvP))
  val zzzkbot       : Opponent = add(Opponent("ZZZKBot",      new StrategySelectionRecommended(StrategySelectionGreedy, PvZ1BaseForgeTech, PvZMidgameNeoBisu)))
  val ualbertabot   : Opponent = add(Opponent("UAlbertaBot",  fixedPvR))
  val aiur          : Opponent = add(Opponent("Aiur",         defaultPvP))
  val tyr           : Opponent = add(Opponent("Tyr",          new StrategySelectionRecommended(StrategySelectionGreedy, PvP2GateDTExpand)))
