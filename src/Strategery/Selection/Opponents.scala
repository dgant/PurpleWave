...
object Opponents {
  ...
  val microwave     : Opponent = add(Opponent("Microwave",    new StrategySelectionRecommended(StrategySelectionDynamic, PvZEarlyFFEEconomic, PvZMidgameGatewayAttack)))
  ...
  val tyr           : Opponent = add(Opponent("Tyr",          defaultPvP))
