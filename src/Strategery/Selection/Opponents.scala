...
object Opponents {
  ...
  // AIST4
  val stardust    : Opponent = add("Stardust",    if (Medusa.matches) StrategySelectionFixed(PvP2GateDTExpand, PvP3rdBaseSlow) else if (Eddy.matches) StrategySelectionFixed(PvP3GateGoon, PvP3rdBaseSlow) else StrategySelectionFixed(PvPRobo1Gate, PvPRobo, PvP3rdBaseSlow))
  val bananabrain : Opponent = add("BananaBrain", if (Medusa.matches) StrategySelectionFixed(PvP2GateDTExpand, PvP3rdBaseSlow) else if (Eddy.matches) StrategySelectionFixed(PvP3GateGoon, PvP3rdBaseSlow) else StrategySelectionFixed(PvPRobo1Gate, PvPRobo, PvP3rdBaseSlow))
