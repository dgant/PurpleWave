...
trait UnitGroup {
  ...
  def attackCentroidAir                 = _attackCentroidAir()
  def attackCentroidGround              = _attackCentroidGround()
  def attackCentroidKey                 = _attackCentroidKey()
  ...
  def maxRangeGround                    = _maxRangeGround()
  def storms                            = _storms()
  def pace01                            = _pace01()
