...
trait UnitGroup {
  ...
  def stepConsensus             : Pixel     = _stepConsensus()
  ...
  private val _stepConsensus              = new Cache(() => GroupCentroid.ground(centroidUnits(attackers), _.presumptiveDestinationNext))
  private val _destinationConsensus       = new Cache(() => GroupCentroid.ground(centroidUnits(attackers), _.presumptiveDestinationFinal))
